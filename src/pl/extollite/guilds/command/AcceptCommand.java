...
public class AcceptCommand extends CommandManager {

    public AcceptCommand() {
        super("guildaccept", "", "/guild accept");
        Map<String, CommandParameter[]> parameters = new HashMap<>();
        this.setCommandParameters(parameters);
        Permission permission = new Permission("guild.command.accept", null, Permission.DEFAULT_TRUE);
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        if (sender instanceof Player) {
           ...
           p.showFormWindow(new AcceptGuildWindow());
        }
        return true;
    }
}
